...
object ScheduleOccurrencePolicyVerification {
  ...
  fun main(args: Array<String>) {
    ...
    try {
      ...
      verify(ScheduleAlarmPresentation.privateBody(summary, "QA memo: bring water and leash.") == "QA memo: bring water and leash.")
      ...
      verify(ScheduleAlarmPresentation.privateBody(summary, longNote) == preview)
