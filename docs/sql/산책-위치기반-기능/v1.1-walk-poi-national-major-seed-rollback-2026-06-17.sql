-- V1.1 walk POI national major city seed rollback
-- Purpose:
-- - Remove the 2026-06-17 national major city seed batch from public projection
...
review_result as (
  ...
  cross join lateral public.walk_poi_admin_review_v1(
    t.walk_poi_id,
    'held',
    'Rollback: hide V1.1 national major city seed batch from public projection while preserving audit/source history.'
  ) as r
)
