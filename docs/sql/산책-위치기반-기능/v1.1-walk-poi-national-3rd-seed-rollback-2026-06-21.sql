-- V1.1 walk POI national 3rd seed rollback
-- Purpose:
-- - Remove the 2026-06-21 national 3rd seed batch from public projection
...
review_result as (
  ...
  cross join lateral public.walk_poi_admin_review_v1(
    t.walk_poi_id,
    'held',
    'Rollback: hide V1.1 national 3rd seed batch from public projection while preserving audit/source history.'
  ) as r
)
