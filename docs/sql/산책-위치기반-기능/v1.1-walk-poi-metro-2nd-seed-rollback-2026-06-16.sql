-- V1.1 walk POI metro-area 2nd seed rollback
-- Purpose:
-- - Remove the 2026-06-16 metro-area 2nd seed batch from public projection
...
review_result as (
  ...
  cross join lateral public.walk_poi_admin_review_v1(
    t.walk_poi_id,
    'held',
    'Rollback: hide V1.1 metro-area 2nd seed batch from public projection while preserving audit/source history.'
  ) as r
)
