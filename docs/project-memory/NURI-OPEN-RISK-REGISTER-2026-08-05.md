...
| AUTH-001 | P1 | public Google/Kakao 정책과 달리 Naver app-side/config/과거 문서가 남아 있다. | NURI-01-인증·온보딩 + NURI-09-Supabase·RLS·RPC·운영DB | OPEN | Naver 유지·hard remove·remote provider 처리의 명시 결정과 코드/문서 정합성 |
