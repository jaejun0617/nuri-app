...
Room: NURI-10-관리자웹·운영도구
Domain: NURI-10-관리자웹·운영도구
...
Ownership:
- screens: admin login, users, reports, content, hospital and operations
- code/services/store: admin web routes/scripts/API clients
- Supabase: admin read/write contracts and audit tables; common security via NURI-09
- tests/docs: admin tests, production operator QA and security docs
- ownership boundary: `/Users/shinjaejun/Desktop/Frontend/Nuri-App/nuri-web` admin routes, operator tools and audit views

Open issue: production operator QA and audit/rollback evidence
...
Bootstrap scope: admin web only; no mobile feature implementation.
Next dependency: activate for approved operator QA or admin feature work.
...
- Ownership doc: `docs/handoffs/2026-08-05/rooms/NURI-10-관리자웹·운영도구-ROOM-OWNERSHIP.md`
- Read canonical docs:
- Screens/code/service/store/Supabase/tests: admin login, users, reports, content, hospital and operations; admin web routes/scripts/API clients; admin read/write contracts and audit tables; common security via NURI-09; admin tests, production operator QA and security docs
- Open issue: ADMIN-001 — production operator QA and audit/rollback evidence
- Existing dirty changes: preserved and not staged
- Implementation status:
- Verification status:
- Release status:
- Boundaries: `/Users/shinjaejun/Desktop/Frontend/Nuri-App/nuri-web` admin routes, operator tools and audit views
