...
Room: NURI-07-알림·운영메시지
Domain: NURI-07-알림·운영메시지
...
Role: domain
Primary issue: notification lifecycle
...
Ownership:
- screens: in-app notification center and message surfaces
- code/services/store: notification services, push-token lifecycle and user notification UI
- Supabase: user_notifications and token lifecycle; shared RLS via NURI-09
- tests/docs: notification/token lifecycle tests
- ownership boundary: `src/screens/Notifications`, notification center and notification services

Open issue: actual push provider is disabled; do not enable from this room
...
Bootstrap scope: in-app notification and future token lifecycle changes.
Next dependency: activate only for approved notification work.
...
- Ownership doc: `docs/handoffs/2026-08-05/rooms/NURI-07-알림·운영메시지-ROOM-OWNERSHIP.md`
- Read canonical docs:
- Screens/code/service/store/Supabase/tests: in-app notification center and message surfaces; notification services, push-token lifecycle and user notification UI; user_notifications and token lifecycle; shared RLS via NURI-09; notification/token lifecycle tests
- Open issue: notification lifecycle — actual push provider is disabled; do not enable from this room
- Existing dirty changes: preserved and not staged
- Implementation status:
- Verification status:
- Release status:
- Boundaries: `src/screens/Notifications`, notification center and notification services
