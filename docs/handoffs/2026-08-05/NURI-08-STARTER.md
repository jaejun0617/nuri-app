...
Ownership:
- screens: hospital list/detail, location discovery, walk POI and pet travel
- code/services/store: animalHospital/locationDiscovery/place/trust services
- Supabase: hospital/POI/travel tables, public projections and provider RPC intent; common security via NURI-09
- tests/docs: hospital/POI/trust/provider boundary tests
- ownership boundary: hospital/location discovery/walk POI/travel screens and trust-facing components

Open issue: candidate/trust/public boundary and provider scope
...
Bootstrap scope: feature contract and read-only candidate presentation; no global trust expansion.
Next dependency: activate when POI/provider/trust work is approved.
...
- Ownership doc: `docs/handoffs/2026-08-05/rooms/NURI-08-동물병원·산책POI·펫여행-ROOM-OWNERSHIP.md`
- Read canonical docs:
- Screens/code/service/store/Supabase/tests: hospital list/detail, location discovery, walk POI and pet travel; animalHospital/locationDiscovery/place/trust services; hospital/POI/travel tables, public projections and provider RPC intent; common security via NURI-09; hospital/POI/trust/provider boundary tests
- Open issue: PLACE-001 — candidate/trust/public boundary and provider scope
- Existing dirty changes: preserved and not staged
- Implementation status:
- Verification status:
- Release status:
- Boundaries: hospital/location discovery/walk POI/travel screens and trust-facing components
