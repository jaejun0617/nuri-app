...
Room: NURI-05-일정·건강·활동
Domain: NURI-05-일정·건강·활동
...
Role: domain
Primary issue: record semantics
...
Ownership:
- screens: schedule, health, activity and related record surfaces
- code/services/store: schedule/health/activity services and components
- Supabase: schedule, health and activity tables/RPC as feature intent; shared security via NURI-09
- tests/docs: schedule/health/activity tests
- ownership boundary: Schedules, HealthReport, walk/activity cards and related services

Open issue: cross-domain record semantics are not an active write task
...
Bootstrap scope: future schedule/health/activity feature or bug work.
Next dependency: create/activate when a domain change is approved.
...
- Ownership doc: `docs/handoffs/2026-08-05/rooms/NURI-05-일정·건강·활동-ROOM-OWNERSHIP.md`
- Read canonical docs:
- Screens/code/service/store/Supabase/tests: schedule, health, activity and related record surfaces; schedule/health/activity services and components; schedule, health and activity tables/RPC as feature intent; shared security via NURI-09; schedule/health/activity tests
- Open issue: record semantics — cross-domain record semantics are not an active write task
- Existing dirty changes: preserved and not staged
- Implementation status:
- Verification status:
- Release status:
- Boundaries: Schedules, HealthReport, walk/activity cards and related services
