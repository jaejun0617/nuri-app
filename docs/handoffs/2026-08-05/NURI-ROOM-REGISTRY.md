...
| 06 | `NURI-06-커뮤니티·모더레이션` | ROOM_EXISTS | BOOTSTRAP_READY | 마스터 승인 시 결정 | ACTIVATE_LATER | WRITE_LOCKED | community policy | `rooms/NURI-06-커뮤니티·모더레이션-ROOM-OWNERSHIP.md` | `NURI-06-STARTER.md` | Home highlights QA evidence | N/A (QA evidence) | no additional Home CommunitySection audit; only narrow policy evidence if separately approved |
...
| 09 | `NURI-09-Supabase·RLS·RPC·운영DB` | ROOM_EXISTS | BOOTSTRAP_READY | 4 | ACTIVATE_SCHEDULED | WRITE_LOCKED | SUPABASE-001 primary, AUTH-001 support | `rooms/NURI-09-Supabase·RLS·RPC·운영DB-ROOM-OWNERSHIP.md` | `NURI-09-STARTER.md` | `0b22f8a` lineage closeout | `0b22f8a` Home highlights lineage | no additional Home highlights backend audit; blocked-user policy only if separately approved |
