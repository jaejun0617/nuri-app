...
| 06 | `NURI-06-커뮤니티·모더레이션` | ROOM_EXISTS | BOOTSTRAP_READY | 마스터 승인 시 결정 | ACTIVATE_LATER | WRITE_ACTIVE | community policy | `rooms/NURI-06-커뮤니티·모더레이션-ROOM-OWNERSHIP.md` | `NURI-06-STARTER.md` | `bb05c09` backend handoff | none | minimum block action integration, then controlled negative visibility QA |
