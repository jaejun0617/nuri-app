...
| 07 | `NURI-07-알림·운영메시지` | ROOM_EXISTS | BOOTSTRAP_READY | 마스터 승인 시 결정 | ACTIVATE_LATER | WRITE_LOCKED | notification lifecycle | `rooms/NURI-07-알림·운영메시지-ROOM-OWNERSHIP.md` | `NURI-07-STARTER.md` | user bootstrap report | none | next release triage target; activate only after NURI-00 dispatch |
