...
| 06 | `NURI-06-커뮤니티·모더레이션` | ROOM_EXISTS | BOOTSTRAP_READY | 마스터 승인 시 결정 | ACTIVATE_LATER | WRITE_COMPLETE | community policy | `rooms/NURI-06-커뮤니티·모더레이션-ROOM-OWNERSHIP.md` | `NURI-06-STARTER.md` | `eaa3c4d` read-only closeout | N/A (audit only) | policy decision recorded; backend implementation delegated to NURI-09 |
...
| 09 | `NURI-09-Supabase·RLS·RPC·운영DB` | ROOM_EXISTS | BOOTSTRAP_READY | 4 | ACTIVATE_SCHEDULED | WRITE_ACTIVE | SUPABASE-001 primary, AUTH-001 support | `rooms/NURI-09-Supabase·RLS·RPC·운영DB-ROOM-OWNERSHIP.md` | `NURI-09-STARTER.md` | `eaa3c4d` Master policy approval | none | targeted block visibility backend closeout in progress |
