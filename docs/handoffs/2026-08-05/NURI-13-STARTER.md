...
Room: NURI-13-가이드·리워드·프라이빗기억
Domain: NURI-13-가이드·리워드·프라이빗기억
...
Role: domain
Primary issue: low-frequency domain
...
Ownership:
- screens: guide, ranking, guestbook, letter and reward screens
- code/services/store: guides/ranking/letters/reward services and components
- Supabase: feature tables and RPC intent; common security via NURI-09
- tests/docs: related feature tests and docs
- ownership boundary: Guides, Ranking, Guestbook, Letters and reward/private memory surfaces

Open issue: no current active write issue
...
Bootstrap scope: future feature maintenance only.
Next dependency: activate when approved product work exists.
...
- Ownership doc: `docs/handoffs/2026-08-05/rooms/NURI-13-가이드·리워드·프라이빗기억-ROOM-OWNERSHIP.md`
- Read canonical docs:
- Screens/code/service/store/Supabase/tests: guide, ranking, guestbook, letter and reward screens; guides/ranking/letters/reward services and components; feature tables and RPC intent; common security via NURI-09; related feature tests and docs
- Open issue: low-frequency domain — no current active write issue
- Existing dirty changes: preserved and not staged
- Implementation status:
- Verification status:
- Release status:
- Boundaries: Guides, Ranking, Guestbook, Letters and reward/private memory surfaces
