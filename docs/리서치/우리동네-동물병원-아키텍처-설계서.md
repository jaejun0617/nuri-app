...
## 2026-06-30 전국 커버리지 read-only audit
...
- 대표 좌표 smoke: 일산, 서울, 부산, 대구, 대전, 광주, 울산, 세종, 제주 모두 10km/20건 반환.
- public active address missing: 0건
- public active coordinate missing: 122건. release blocker는 아니며 후속 데이터 품질 점검 후보로 둔다.
